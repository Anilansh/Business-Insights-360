...
## Data Model
The project uses a **Snowflake Schema** for structured data relationships between sales, market, product, and customer dimensions.  
...
**Highlights:** Features a performance matrix, product-level profitability, and region-wise contribution to total revenue.  
...
![Supply Chain View](images/Supply%20Chain.PNG)
